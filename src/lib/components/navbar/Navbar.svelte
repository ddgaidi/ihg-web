...
<div class="flex justify-between items-center bg-[#0c0c1c] py-2 px-8" id="navbar-container">
  <!-- Logo -->
  ...
  <div class="flex space-x-16" id="pages-container">
    <a href="/" class="nav-item group">
      <div class="nav-content bg-gradient-to-tr from-[#2443a1] to-[#5eb3f4] group-hover:shadow-[0_2px_20px_3px_rgba(30,100,255,0.7)] transition-all duration-500">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" class="fill-current icon group-hover:rotate-12 text-[#bee3ff] group-hover:text-white transition-all duration-500">
          <path d="M23.121,9.069,15.536,1.483a5.008,5.008,0,0,0-7.072,0L.879,9.069A2.978,2.978,0,0,0,0,11.19v9.817a3,3,0,0,0,3,3H21a3,3,0,0,0,3-3V11.19A2.978,2.978,0,0,0,23.121,9.069ZM15,22.007H9V18.073a3,3,0,0,1,6,0Zm7-1a1,1,0,0,1-1,1H17V18.073a5,5,0,0,0-10,0v3.934H3a1,1,0,0,1-1-1V11.19a1.008,1.008,0,0,1,.293-.707L9.878,2.9a3.008,3.008,0,0,1,4.244,0l7.585,7.586A1.008,1.008,0,0,1,22,11.19Z"/>
        </svg>
        <span class="text-[#bee3ff] font-bold group-hover:text-white transition-all duration-500">Accueil</span>
      </div>
    </a>

    <a href="/jeux" class="nav-item group">
      <div class="nav-content bg-gradient-to-tr from-[#2c54] to-[#79f8dd] group-hover:shadow-[0_2px_20px_3px_rgba(62,158,136,0.7)] transition-all duration-500">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="20" height="20" class="fill-current icon group-hover:rotate-12 text-[#d4fff6] group-hover:text-white transition-all duration-500">
        ...
        <span class="text-[#d4fff6] font-bold group-hover:text-white transition-all duration-500">Jeux</span>
      </div>
    </a>

    <a href="/prochainement" class="nav-item group">
      <div class="nav-content bg-gradient-to-tr from-[#4e1cc2] to-[#ca82f7] group-hover:shadow-[0_2px_20px_3px_rgba(105,70,212,0.7)] transition-all duration-500">
        <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                width="20"
                height="20"
                class="fill-current icon group-hover:rotate-12 text-[#e0d3ff] group-hover:text-white transition-all duration-500"
        >
        ...
        <span class="text-[#e0d3ff] font-bold group-hover:text-white transition-all duration-500">Prochainement</span>
      </div>
    </a>

    <a href="/support" class="nav-item group">
      <div class="nav-content bg-gradient-to-tr from-[#ff6410] to-[#f29d56] group-hover:shadow-[0_2px_20px_3px_rgba(255,133,66,0.7)] transition-all duration-500">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" class="fill-current icon group-hover:rotate-12 text-[#ffd1ab] group-hover:text-white transition-all duration-500">
        ...
        <span class="text-[#ffd1ab] font-bold group-hover:text-white transition-all duration-500">Support</span>
      </div>
    </a>
  </div>
  ...
  <div id="right-container" class="flex space-x-8 mr-12">
    ...
    <div id="settings-modal" bind:this={settingsModal} class="fixed left-[-30px] inset-0 flex items-center justify-center bg-black bg-opacity-80 hidden">
      <div class="bg-white w-[600px] h-[400px] rounded-lg p-5">
        <div class="flex justify-between items-center mb-4">
          <h1 class="text-xl font-bold">PARAMETRES :</h1>
          <button
    ...
    <!-- Profile Icon -->
    <div id="profile-container" class="hover:scale-110 transition-transform duration-500">
      <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              width="24"
